...
function fuseBothPoke() {
    ...
    var img = new Image();
    img.src = "https://raw.githubusercontent.com/infinitefusion/autogen-fusion-sprites/master/Battlers/" + pic1;
    img.onload = function () {
    ...
    var abilitiesText1 = sanitizeAbilityList(abilities1);
    ...
    var abilitiesText2 = sanitizeAbilityList(abilties2);
